...
package trinomiocuadradoperfectot;
 ...
 * @date: 06-09-2015 
 */
public class Trinomiocuadradoperfecto extends JFrame {
	 ...
	 */
	public Trinomiocuadradoperfecto() {
		super();
		setSize(250, 300);
	...
	private void numeroPulsado(String digito) {
		if (pantalla.getText().equals("0") || nuevaOperacion) {
			pantalla.setText(digito);
                        datito1= Integer.parseInt(digito);
                        System.out.println(datito1);
		} else {
			pantalla.setText(pantalla.getText() + digito);
                         datito2= Integer.parseInt(digito);
                         System.out.println(datito2);
		}
	...
	private void calcularResultado() {
		if (operacion.equals("Trinomio")) {
                  res=""+(resultado*resultado)+"x^2+"+(resultado* new Double(pantalla.getText())*2)+"x+"+( new Double(pantalla.getText())* new Double(pantalla.getText()));
